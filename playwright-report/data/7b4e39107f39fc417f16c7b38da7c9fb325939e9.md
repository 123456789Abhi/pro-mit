...
- Name: super-admin\performance\performance.spec.ts >> Performance - Page Load >> 2.4 - Combined filter application <1s
- Location: tests\super-admin\performance\performance.spec.ts:51:7
