...
- Name: super-admin\performance\performance.spec.ts >> Performance - Page Load >> 2.15 - Image upload (5MB) <3s
- Location: tests\super-admin\performance\performance.spec.ts:216:7
