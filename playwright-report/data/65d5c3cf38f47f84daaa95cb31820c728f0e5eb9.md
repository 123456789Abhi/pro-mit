...
- Name: super-admin\performance\performance.spec.ts >> Performance - Page Load >> 2.1 - Command Center load time <3s p95
- Location: tests\super-admin\performance\performance.spec.ts:9:7
