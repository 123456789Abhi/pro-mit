...
- Name: super-admin\performance\performance.spec.ts >> Performance - Page Load >> 2.6 - Pre-gen content table with cursor pagination <2s
- Location: tests\super-admin\performance\performance.spec.ts:79:7
