...
- Name: super-admin\functional\schools.spec.ts >> Financials >> 1.16 - AI cost monitor loads
- Location: tests\super-admin\functional\schools.spec.ts:317:7
...
Call log:
  - waiting for locator('text=AI Cost Monitor')
