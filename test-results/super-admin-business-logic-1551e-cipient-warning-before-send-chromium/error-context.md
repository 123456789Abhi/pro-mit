...
- Name: super-admin\business-logic\business-logic.spec.ts >> Business Logic - Edge Cases >> 10.17 - Zero-recipient warning before send
- Location: tests\super-admin\business-logic\business-logic.spec.ts:286:7
...
- generic [active] [ref=e1]:
  ...
  - region "Notifications alt+T":
    - list:
      - listitem [ref=e28]:
        - button "Close toast" [ref=e29] [cursor=pointer]:
          - img [ref=e30]
        - img [ref=e34]
        - generic [ref=e37]: Welcome back!
  - alert [ref=e38]
```
