...
- Name: super-admin\api-integration\api.spec.ts >> API & Integration - Supabase >> 9.4 - Gemini API integration
- Location: tests\super-admin\api-integration\api.spec.ts:65:7
