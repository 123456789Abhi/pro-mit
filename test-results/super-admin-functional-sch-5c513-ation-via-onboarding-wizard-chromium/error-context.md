...
- Name: super-admin\functional\schools.spec.ts >> Schools Management >> 1.1 - School creation via onboarding wizard
- Location: tests\super-admin\functional\schools.spec.ts:14:7
