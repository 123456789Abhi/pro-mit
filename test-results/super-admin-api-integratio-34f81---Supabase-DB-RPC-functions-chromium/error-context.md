...
- Name: super-admin\api-integration\api.spec.ts >> API & Integration - Supabase >> 9.2 - Supabase DB RPC functions
- Location: tests\super-admin\api-integration\api.spec.ts:24:7
