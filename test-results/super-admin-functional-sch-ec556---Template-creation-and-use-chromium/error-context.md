...
- Name: super-admin\functional\schools.spec.ts >> Communicate >> 1.13 - Template creation and use
- Location: tests\super-admin\functional\schools.spec.ts:280:7
...
Call log:
  - waiting for locator('button:has-text("Create Template")')
