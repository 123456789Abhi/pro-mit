...
- Name: super-admin\api-integration\api.spec.ts >> API & Integration - Supabase >> 9.6 - OpenAI Embeddings integration
- Location: tests\super-admin\api-integration\api.spec.ts:105:7
