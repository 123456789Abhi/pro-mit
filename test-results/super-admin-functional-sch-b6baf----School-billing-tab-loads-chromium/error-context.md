...
- Name: super-admin\functional\schools.spec.ts >> Financials >> 1.15 - School billing tab loads
- Location: tests\super-admin\functional\schools.spec.ts:308:7
...
Call log:
  - waiting for locator('text=School Billing')
